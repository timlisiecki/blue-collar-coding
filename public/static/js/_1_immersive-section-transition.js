...
(function () {
	...
	function resetSection(element) {
		...
		element.element.dispatchEvent(
			new CustomEvent('immersive-section-updated', { detail: { active: element.active, asset: element.visibleFigure } })
		);
	}
	...
	function updateMediaHeight(element) {
		...
		element.scrollDelta =
			window.innerHeight - element.visibleFigure.offsetHeight > window.innerWidth - element.visibleFigure.offsetWidth
